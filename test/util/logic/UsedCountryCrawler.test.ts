...
describe('UsedCountryCrawler', () => {
    let crawler: UsedCountryCrawler;
    let page: Page;

    beforeEach(() => {
        crawler = new UsedCountryCrawler();
        page = mock<Page>();
    });
    ...
    describe('crawl 함수 테스트', () => {
        ...
        it('crawl 정상 테스트', async () => {
            ...
            expect(page.goto).toHaveBeenCalledWith(`https://web.joongna.com/search/${searchWord}`, { timeout: 0 });
        });
